---
title: "Project 3 - Main_Baseline"
author: "Chengliang Tang, Tian Zheng, Group 10: Peilu Zhang"
...
```{r wkdir, eval=FALSE}
set.seed(2018)
setwd("~/Documents/2018-fall-study/5243/proj3")
...
```{r}
train_dir <- "~/Documents/2018-fall-study/5243/proj3/data/train_set/" # This will be modified for different data sets.
...
```{r feature}
source("~/Documents/2018-fall-study/5243/proj3/lib/feature_baseline.R")
...
save(dat_train, file="~/Documents/2018-fall-study/5243/proj3/output/feature_train_baseline.RData")
tm_feature_train
```
...
```{r loadlib}
source("~/Documents/2018-fall-study/5243/proj3/lib/train_baseline.R")
source("~/Documents/2018-fall-study/5243/proj3/lib/test_baseline.R")
```
...
source("~/Documents/2018-fall-study/5243/proj3/lib/cross_validation_baseline.R")
...
```{r cv_vis}
if(run.cv){
  load("~/Documents/2018-fall-study/5243/proj3/output/err_cv_baseline.RData")
  plot(model_values, err_cv[,1], xlab="Interaction Depth", ylab="CV Error",
       main="Cross Validation Error", type="n", ylim=c(0, 0.025))
...
```
For baseline we only use depth = 1
```{r}
par_best1= list(depth = 1)
```

* Train the model with the entire training set using the selected model (model parameter) via cross-validation.
```{r final_train}
tm_train=NA
tm_train <- system.time(fit_train <- train(feat_train, label_train, par_best1))
save(fit_train, file="~/Documents/2018-fall-study/5243/proj3/output/fit_train_baseline.RData")
```
...
```{r superresolution}
source("~/Documents/2018-fall-study/5243/proj3/lib/superResolution_baseline.R")
test_dir <- "~/Documents/2018-fall-study/5243/proj3/data/test_set/" # This will be modified for different data sets.
test_LR_dir <- paste(test_dir, "LR/", sep="")
test_HR_dir <- paste(test_dir, "HR/", sep="")

tm_test=NA
if(run.test){
  load(file="~/Documents/2018-fall-study/5243/proj3/output/fit_train.RData")
...
calculate_psnr <- function(pred_dir, true_dir){
  ...
  name <- c("Total")
  for (i in 1:n_pred){
    imgPred <- OpenImageR::readImage(paste0(test_HR_dir,  "img_", sprintf("%04d", 1), ".jpg"))
...
library(OpenImageR)
# set directory
HR_dir1 = "~/Documents/2018-fall-study/5243/proj3/data/train_set2/HR/"
train_HR_dir1 <- paste(HR_dir1, sep = "")
HR_dir_test = "~/Documents/2018-fall-study/5243/proj3/data/test_set2/HR/"
test_HR_dir = paste(HR_dir_test, sep = "")
# psnr for baseline
psnr_baseline = calculate_psnr(test_HR_dir,train_HR_dir1)
psnr_baseline
